...
public class MenuScene extends Scene{
    ...
    public void init() {
        ...
        tittle.setStrokeColor(new Color(100,100,100));
        tittle.setPosition(2*buttonX, 100);
        tittle.setSize(buttonW,100);
        addGameObject(tittle);

        //button
        GameObject button =(GameObject)new TextObject(this, font,"Jugar");
        button.setStrokeColor(new Color(0,0,0));
        button.setPosition(3* buttonX, 375);
        button.setSize(center,45);
